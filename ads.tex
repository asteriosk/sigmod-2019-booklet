...
\includegraphics[keepaspectratio,width=.4\textheight,height=\textwidth]{ads/megagon-cropped.pdf}
...
\vfill
$\vcenter{\hbox{\includegraphics[keepaspectratio,width=.49\textheight,height=.49\textwidth,angle=90]{sponsoricons/celonis}}}$
\hfill
...
\hfill
$\vcenter{\hbox{\includegraphics[keepaspectratio,width=.49\textheight,height=.49\textwidth,angle=270]{sponsoricons/celonis}}}$
\vfill
