...
\sessiontimeloc{Monday 10:00-11:00}{Graanbeurs}
\sessionlocation{Graanbeurs}
...
\sessiontimeloc{Monday 11:30-13:00}{Graanbeurs}
\sessionlocation{Graanbeurs}
...
\sessiontimeloc{Monday 14:30-16:30}{Graanbeurs}
\sessionlocation{Graanbeurs}
...
\sessiontimeloc{Monday 17:00-18:00}{Graanbeurs}
\sessionlocation{Graanbeurs}
...
\sessiontimeloc{Monday 18:00-19:00}{Graanbeurs}
\sessionlocation{Graanbeurs}
...
\begin{minipage}{\textwidth}
\papertitle{Talk No.2}{http://adityagp.net}
\paperauthors{Aditya Parameswaran (University of California, Berkeley)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk No.3}{http://azza.azurewebsites.net/}
\paperauthors{Azza Abouzied (New York University, Abu Dhabi)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk No.4}{https://stratos.seas.harvard.edu/}
\paperauthors{Stratos Idreos (Harvard University)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk No.5}{http://lig-membres.imag.fr/amery/}
\paperauthors{Sihem Amer-Yahia (CNRS)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk No.6}{https://web.eecs.umich.edu/~jag/}
