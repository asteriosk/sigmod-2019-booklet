...
\sessionname{PODS Opening + Keynote}{PODS Keynote}\\
\sessionlocation{Effectenbeurszaal}
...
\sessionname{SIGMOD Research 1}{SIGMOD Research 1: Query Processing \& Optimization 1}\\
\sessionlocation{Effectenbeurszaal}
...
\sessionname{PODS Tutorial 1}{PODS Invited Tutorial 1}\\
\sessionlocation{Veilingzaal}
