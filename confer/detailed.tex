...
\begin{minipage}{\textwidth}
\sessionname{PODS Test-of-Time \& Gems}{Test-of-Time Award and Two Gems of PODS Talks}\\
...
\begin{minipage}{\textwidth}
\sessionname{Student Research Competition}{Student Research Competition}\\
...
\begin{minipage}{\textwidth}
\papertitle{Talk \#1: Publication Strategies for New Researchers: intro by the organizers}{https://http://sigmod2019.org/new_researchers_symp}
\paperauthors{Katja Hose (Aalborg University), Spyros Blanas (Ohio State University)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk \#2 (unknown title)}{http://adityagp.net}
\paperauthors{Aditya Parameswaran (University of California, Berkeley)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk \#3 (unknown title)}{http://azza.azurewebsites.net/}
\paperauthors{Azza Abouzied (New York University, Abu Dhabi)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk \#4 (unknown title)}{https://stratos.seas.harvard.edu/}
\paperauthors{Stratos Idreos (Harvard University)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk \#5 (unknown title)}{http://lig-membres.imag.fr/amery/}
\paperauthors{Sihem Amer-Yahia (CNRS)}
\end{minipage}

\begin{minipage}{\textwidth}
\papertitle{Talk \#6 (unknown title)}{https://web.eecs.umich.edu/~jag/}
